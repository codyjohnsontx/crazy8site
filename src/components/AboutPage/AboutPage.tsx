...
// Look into map method for rendering Sergio data
const AboutPage = () => {
    return (
        <div className="about-page">
            ...
            <section className="team-section">
                ...
                <div className="team-member">
                    <h3>Sergio Ortiz</h3>
                    <img src="src/assets/Sergio.png" alt="A picture of Sergio Ortiz" />
